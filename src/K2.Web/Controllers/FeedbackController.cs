        ...
        public IActionResult Feedback(HttpStatusCode httpStatusCode)
        {
            ...
            switch (httpStatusCode)
            {
                ...
                case HttpStatusCode.Unauthorized:
                    ...
                    break;
                default:
                    feedback = new Feedback(TipoFeedback.Atencao, "Não foi possível acessar a página ou funcionalidade.", tipoAcao: TipoAcaoAoOcultarFeedback.VoltarPaginaAnterior);
                    break;
            }
