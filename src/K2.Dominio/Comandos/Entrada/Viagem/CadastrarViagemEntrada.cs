...
namespace K2.Dominio.Comandos.Entrada
{
    ...
    /// </summary>
    public class CadastrarViagemEntrada : Notificavel, IEntrada
    {
        /// <summary>
        /// ID do carro
        /// </summary>
            ...
            )
        {
            ...
            KmFinal                   = kmFinal;
            KmRodado                  = kmRodado;
            NomeContratanteFrete      = nomeContratanteFrete?.ToUpper();
            EnderecoContratanteFrete  = enderecoContratanteFrete?.ToUpper();
