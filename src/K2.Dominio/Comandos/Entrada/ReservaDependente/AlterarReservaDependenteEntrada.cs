...
{
    /// <summary>
    /// Comando utilizado para o alterar um dependente de uma reserva
    /// </summary>
    public class AlterarReservaDependenteEntrada : Notificavel, IEntrada
    {
        /// <summary>
        /// ID da reserva
        /// </summary>
        ...
        public AlterarReservaDependenteEntrada(
            int idReserva,
            string nome,
