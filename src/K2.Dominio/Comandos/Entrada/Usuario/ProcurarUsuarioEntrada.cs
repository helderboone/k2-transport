...
namespace K2.Dominio.Comandos.Entrada
{
    public class ProcurarUsuarioEntrada : ProcurarEntrada
    {
        ...
        {
            this.NotificarSeNulo(typeof(Usuario).GetProperty(this.OrdenarPor, BindingFlags.IgnoreCase | BindingFlags.Public | BindingFlags.Instance), $"A propriedade {this.OrdenarPor} não pertence a classe \"Usuario\".");
        }
    }
}
