...
namespace K2.Dominio.Servicos
{
    public class ReservaServico : Notificavel, IReservaServico
    {
        ...
        public async Task<ISaida> ObterReservasPorViagem(int idViagem, CredencialUsuarioEntrada credencial)
        {
            ...
            {
                case TipoPerfil.Motorista:
                    this.NotificarSeVerdadeiro(viagem.Motorista.IdUsuario != credencial.IdUsuario, ReservaResource.Motorista_Sem_Permissao_Obter);
                    break;
                case TipoPerfil.ProprietarioCarro:
                    this.NotificarSeVerdadeiro(viagem.Carro.Proprietario.IdUsuario != credencial.IdUsuario, ReservaResource.Proprietario_Sem_Permissao_Obter);
                    break;
            }
